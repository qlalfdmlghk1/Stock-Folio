...
const triggerStateClasses: Record<ComputedState, string> = {
  ...
  focused: "border-blue-500 bg-gray-800",
  disabled: "bg-gray-900 border-gray-700 cursor-not-allowed",
  error: "border-red-500 bg-gray-800",
  "error-focused": "border-red-500 bg-gray-800",
};

const valueColorMap: Record<ComputedState, { value: string; placeholder: string }> = {
  default: { value: "text-gray-100", placeholder: "text-gray-500" },
  focused: { value: "text-gray-100", placeholder: "text-gray-500" },
  disabled: { value: "text-gray-500", placeholder: "text-gray-600" },
  error: { value: "text-red-400", placeholder: "text-red-400" },
  "error-focused": { value: "text-gray-100", placeholder: "text-gray-500" },
};

const arrowColorMap: Record<ComputedState, string> = {
  default: "text-gray-400",
  focused: "text-gray-300",
  disabled: "text-gray-600",
  error: "text-red-400",
  "error-focused": "text-gray-400",
};
  ...
  const classes = [
    ...
    disabled
      ...
      : highlighted
        ...
        : "bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-gray-100 active:bg-gray-600 active:text-gray-100",
  ]
    .filter(Boolean)
    .join(" ");
    ...
    >
      {multiple && (
        <input
          ...
          disabled={disabled}
          readOnly
          className="w-4 h-4 rounded border-gray-600 text-blue-500 pointer-events-none accent-blue-500"
          tabIndex={-1}
        />
      )}
...
export default function AppSelect({
  ...
  const listboxClasses = [
    ...
    "bg-gray-800 border border-gray-700 rounded-[6px]",
